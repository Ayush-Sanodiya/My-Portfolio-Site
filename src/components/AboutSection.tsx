...
export default function AboutSection() {
  return (
    <section id="about" className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden bg-[#0C0C0C]">
      {/* Decorative Assets */}
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[4%] sm:top-[4%] left-[1%] sm:left-[2%] md:left-[4%] w-[80px] sm:w-[160px] md:w-[210px] z-10 opacity-30 sm:opacity-100">
      ...
      <FadeIn delay={0.25} x={-80} y={0} duration={0.9} className="absolute bottom-[4%] sm:bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] w-[70px] sm:w-[140px] md:w-[180px] z-10 opacity-30 sm:opacity-100">
      ...
      <FadeIn delay={0.15} x={80} y={0} duration={0.9} className="absolute top-[4%] sm:top-[4%] right-[1%] sm:right-[2%] md:right-[4%] w-[80px] sm:w-[160px] md:w-[210px] z-10 opacity-30 sm:opacity-100">
      ...
      <FadeIn delay={0.3} x={80} y={0} duration={0.9} className="absolute bottom-[4%] sm:bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] w-[90px] sm:w-[170px] md:w-[220px] z-10 opacity-30 sm:opacity-100">
